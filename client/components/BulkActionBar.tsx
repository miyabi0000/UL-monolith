  ...
  return (
    <>
      ...
      {isCompareMode && selectedCount > 0 && !canCompare && compareDisabledReason && (
        <div className="px-4 py-2 mb-2 rounded-md bg-gray-100 neu-raised flex items-center gap-2">
      ...
      <div className="flex items-center justify-between px-4 py-3 rounded-md mb-4 bg-gray-100/25 neu-raised">
      {/* 左側: 選択情報 */}
