    ...
    <main className="max-w-4xl mx-auto px-4 sm:px-6 md:px-8 lg:px-[16px] py-4">
      <section className="glass-surface p-4 mb-4">
        ...
        <div className="mt-4 grid grid-cols-3 gap-2 text-xs">
          <div className="rounded-md bg-white/55 dark:bg-slate-800/60 px-2 py-2">
      ...
      <section className="glass-surface p-0 overflow-hidden">
        <div className="grid grid-cols-[1fr_auto_auto] gap-2 px-4 py-2 text-xs font-medium text-gray-500 dark:text-gray-400 border-b border-gray-200/70 dark:border-slate-600">
          <span>Item</span>
          <span>Weight</span>
          <span>Price</span>
        </div>
        ...
        {!isLoading &&
          items.map((item) => (
            <div
              key={item.id}
              className="grid grid-cols-[1fr_auto_auto] gap-2 px-4 py-2 text-sm border-b border-gray-100 dark:border-slate-700/70 last:border-b-0"
            >
